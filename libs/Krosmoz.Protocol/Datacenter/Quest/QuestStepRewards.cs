...
public sealed class QuestStepRewards : IDatacenterObject
{
	...
	public void Deserialize(D2OClass d2OClass, BigEndianReader reader)
	{
		...
		ItemsReward = d2OClass.Fields[4].AsListOfList(reader, static (field, r) => field.AsUInt(r));
		EmotesReward = d2OClass.Fields[5].AsList(reader, static (field, r) => field.AsUInt(r));
		JobsReward = d2OClass.Fields[6].AsList(reader, static (field, r) => field.AsUInt(r));
