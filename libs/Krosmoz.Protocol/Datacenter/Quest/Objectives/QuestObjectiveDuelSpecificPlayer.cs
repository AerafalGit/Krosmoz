...
public sealed class QuestObjectiveDuelSpecificPlayer : QuestObjective, IDatacenterObject<QuestObjectiveDuelSpecificPlayer>
{
	public static new string ModuleName =>
		"QuestObjectives";

	public static new QuestObjectiveDuelSpecificPlayer Deserialize(D2OClass d2OClass, BigEndianReader reader)
	{
		return new QuestObjectiveDuelSpecificPlayer
		{
