...
public sealed class AchievementObjective : IDatacenterObject<AchievementObjective>
{
	...
	public static AchievementObjective Deserialize(D2OClass d2OClass, BigEndianReader reader)
	{
