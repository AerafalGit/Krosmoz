...
public sealed class Skill : IDatacenterObject<Skill>
{
	...
	public static Skill Deserialize(D2OClass d2OClass, BigEndianReader reader)
	{
		return new Skill
		{
			...
			CraftableItemIds = d2OClass.Fields[6].AsList<int>(reader, static (field, r) => field.AsInt(r)),
