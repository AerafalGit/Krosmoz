...
public class TreasureHuntDigRequestAnswerMessage : DofusMessage
{
	public new const uint StaticProtocolId = 6484;

	public override uint ProtocolId =>
		StaticProtocolId;

	public static TreasureHuntDigRequestAnswerMessage Empty =>
