...
public sealed class CensoredContent : IDatacenterObject<CensoredContent>
{
	...
	public static CensoredContent Deserialize(D2OClass d2OClass, BigEndianReader reader)
	{
		return new CensoredContent
		{
