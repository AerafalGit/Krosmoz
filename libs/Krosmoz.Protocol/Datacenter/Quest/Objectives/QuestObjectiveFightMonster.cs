...
public sealed class QuestObjectiveFightMonster : QuestObjective, IDatacenterObject<QuestObjectiveFightMonster>
{
	public static new string ModuleName =>
		"QuestObjectives";

	public static new QuestObjectiveFightMonster Deserialize(D2OClass d2OClass, BigEndianReader reader)
	{
		return new QuestObjectiveFightMonster
		{
