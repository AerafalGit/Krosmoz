...
public sealed class QuestObjectiveDiscoverSubArea : QuestObjective, IDatacenterObject<QuestObjectiveDiscoverSubArea>
{
	public static new string ModuleName =>
		"QuestObjectives";

	public static new QuestObjectiveDiscoverSubArea Deserialize(D2OClass d2OClass, BigEndianReader reader)
	{
		return new QuestObjectiveDiscoverSubArea
		{
