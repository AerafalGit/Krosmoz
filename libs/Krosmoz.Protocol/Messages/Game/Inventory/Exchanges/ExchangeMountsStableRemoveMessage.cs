...
public sealed class ExchangeMountsStableRemoveMessage : DofusMessage
{
	public new const uint StaticProtocolId = 6556;

	public override uint ProtocolId =>
		StaticProtocolId;

	public static ExchangeMountsStableRemoveMessage Empty =>
		new() { MountsId = [] };
