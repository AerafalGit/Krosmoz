...
public sealed class Achievement : IDatacenterObject<Achievement>
{
	...
	public static Achievement Deserialize(D2OClass d2OClass, BigEndianReader reader)
	{
		return new Achievement
		{
			...
			ObjectiveIds = d2OClass.Fields[11].AsList<int>(reader, static (field, r) => field.AsInt(r)),
			RewardIds = d2OClass.Fields[12].AsList<int>(reader, static (field, r) => field.AsInt(r)),
		};
	}
}
