...
public sealed class QuestObjectiveMultiFightMonster : QuestObjective, IDatacenterObject<QuestObjectiveMultiFightMonster>
{
	public static new string ModuleName =>
		"QuestObjectives";

	public static new QuestObjectiveMultiFightMonster Deserialize(D2OClass d2OClass, BigEndianReader reader)
	{
		return new QuestObjectiveMultiFightMonster
		{
