...
public sealed class QuestObjectiveBringSoulToNpc : QuestObjective, IDatacenterObject<QuestObjectiveBringSoulToNpc>
{
	public static new string ModuleName =>
		"QuestObjectives";

	public static new QuestObjectiveBringSoulToNpc Deserialize(D2OClass d2OClass, BigEndianReader reader)
	{
		return new QuestObjectiveBringSoulToNpc
		{
