...
public sealed class Dungeon : IDatacenterObject<Dungeon>
{
	...
	public static Dungeon Deserialize(D2OClass d2OClass, BigEndianReader reader)
	{
		return new Dungeon
		{
			...
			MapIds = d2OClass.Fields[3].AsList<int>(reader, static (field, r) => field.AsInt(r)),
