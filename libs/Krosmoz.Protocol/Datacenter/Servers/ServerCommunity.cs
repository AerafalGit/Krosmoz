...
public sealed class ServerCommunity : IDatacenterObject<ServerCommunity>
{
	...
	public static ServerCommunity Deserialize(D2OClass d2OClass, BigEndianReader reader)
	{
		return new ServerCommunity
		{
