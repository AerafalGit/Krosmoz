...
public sealed class TreasureHuntFlagRequestMessage : DofusMessage
{
	public new const uint StaticProtocolId = 6508;

	public override uint ProtocolId =>
		StaticProtocolId;

	public static TreasureHuntFlagRequestMessage Empty =>
