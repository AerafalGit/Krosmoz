...
public sealed class Weapon : Item, IDatacenterObject<Weapon>
{
	...
	public static new Weapon Deserialize(D2OClass d2OClass, BigEndianReader reader)
	{
		return new Weapon
		{
			...
			RecipeIds = d2OClass.Fields[8].AsList<uint>(reader, static (field, r) => field.AsUInt(r)),
			...
			DropMonsterIds = d2OClass.Fields[13].AsList<uint>(reader, static (field, r) => field.AsUInt(r)),
			...
			FavoriteSubAreas = d2OClass.Fields[19].AsList<uint>(reader, static (field, r) => field.AsUInt(r)),
