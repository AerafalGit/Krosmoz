...
public sealed class ExchangeObjectsAddedMessage : ExchangeObjectMessage
{
	public new const uint StaticProtocolId = 6535;

	public override uint ProtocolId =>
		StaticProtocolId;

	public static new ExchangeObjectsAddedMessage Empty =>
