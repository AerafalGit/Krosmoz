...
public sealed class AbuseReasons : IDatacenterObject<AbuseReasons>
{
	...
	public static AbuseReasons Deserialize(D2OClass d2OClass, BigEndianReader reader)
	{
		return new AbuseReasons
		{
