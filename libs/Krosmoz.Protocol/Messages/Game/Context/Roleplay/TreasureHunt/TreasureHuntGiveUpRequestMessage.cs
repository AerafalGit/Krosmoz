...
public sealed class TreasureHuntGiveUpRequestMessage : DofusMessage
{
	public new const uint StaticProtocolId = 6487;

	public override uint ProtocolId =>
		StaticProtocolId;

	public static TreasureHuntGiveUpRequestMessage Empty =>
		new() { QuestType = 0 };
