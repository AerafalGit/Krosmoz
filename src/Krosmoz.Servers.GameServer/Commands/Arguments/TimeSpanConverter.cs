...
/// </summary>
public sealed partial class TimeSpanConverter : IArgumentConverter<TimeSpan>
{
    /// <summary>
    ...
    /// <returns>
    /// A <see cref="ValueTask{TResult}"/> containing the converted <see cref="TimeSpan"/> value if successful,
    /// or <see cref="TimeSpan.Zero"/> if the conversion fails or the argument is invalid.
    /// </returns>
    public ValueTask<TimeSpan> ConvertAsync(CommandContext context, CancellationToken cancellationToken)
    {
