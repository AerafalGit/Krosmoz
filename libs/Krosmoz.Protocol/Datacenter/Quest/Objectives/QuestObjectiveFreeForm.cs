...
public sealed class QuestObjectiveFreeForm : QuestObjective, IDatacenterObject<QuestObjectiveFreeForm>
{
	public static new string ModuleName =>
		"QuestObjectives";

	public static new QuestObjectiveFreeForm Deserialize(D2OClass d2OClass, BigEndianReader reader)
	{
		return new QuestObjectiveFreeForm
		{
