...
public sealed class SubArea : IDatacenterObject
{
	...
	public void Deserialize(D2OClass d2OClass, BigEndianReader reader)
	{
		...
		MapIds = d2OClass.Fields[4].AsList(reader, static (field, r) => field.AsUInt(r));
		Bounds = d2OClass.Fields[5].AsObject<Rectangle>(reader);
		Shape = d2OClass.Fields[6].AsList(reader, static (field, r) => field.AsInt(r));
		CustomWorldMap = d2OClass.Fields[7].AsList(reader, static (field, r) => field.AsUInt(r));
		...
		Monsters = d2OClass.Fields[12].AsList(reader, static (field, r) => field.AsUInt(r));
		EntranceMapIds = d2OClass.Fields[13].AsList(reader, static (field, r) => field.AsUInt(r));
		ExitMapIds = d2OClass.Fields[14].AsList(reader, static (field, r) => field.AsUInt(r));
