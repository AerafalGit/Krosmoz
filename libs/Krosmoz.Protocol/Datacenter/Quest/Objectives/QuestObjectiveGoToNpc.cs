...
public sealed class QuestObjectiveGoToNpc : QuestObjective, IDatacenterObject<QuestObjectiveGoToNpc>
{
	public static new string ModuleName =>
		"QuestObjectives";

	public static new QuestObjectiveGoToNpc Deserialize(D2OClass d2OClass, BigEndianReader reader)
	{
		return new QuestObjectiveGoToNpc
		{
