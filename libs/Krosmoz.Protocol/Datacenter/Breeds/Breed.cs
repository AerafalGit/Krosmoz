...
public sealed class Breed : IDatacenterObject<Breed>
{
	...
	public static Breed Deserialize(D2OClass d2OClass, BigEndianReader reader)
	{
		return new Breed
		{
			...
			StatsPointsForStrength = d2OClass.Fields[10].AsListOfList<uint>(reader, static (field, r) => field.AsUInt(r)),
			StatsPointsForIntelligence = d2OClass.Fields[11].AsListOfList<uint>(reader, static (field, r) => field.AsUInt(r)),
			StatsPointsForChance = d2OClass.Fields[12].AsListOfList<uint>(reader, static (field, r) => field.AsUInt(r)),
			StatsPointsForAgility = d2OClass.Fields[13].AsListOfList<uint>(reader, static (field, r) => field.AsUInt(r)),
			StatsPointsForVitality = d2OClass.Fields[14].AsListOfList<uint>(reader, static (field, r) => field.AsUInt(r)),
			StatsPointsForWisdom = d2OClass.Fields[15].AsListOfList<uint>(reader, static (field, r) => field.AsUInt(r)),
			BreedSpellsId = d2OClass.Fields[16].AsList<uint>(reader, static (field, r) => field.AsUInt(r)),
			MaleColors = d2OClass.Fields[17].AsList<uint>(reader, static (field, r) => field.AsUInt(r)),
			FemaleColors = d2OClass.Fields[18].AsList<uint>(reader, static (field, r) => field.AsUInt(r)),
		};
	}
}
