...
public sealed class AlignmentRank : IDatacenterObject<AlignmentRank>
{
	...
	public static AlignmentRank Deserialize(D2OClass d2OClass, BigEndianReader reader)
	{
		return new AlignmentRank
		{
			...
			Gifts = d2OClass.Fields[6].AsList<int>(reader, static (field, r) => field.AsInt(r)),
		};
	}
}
