...
public sealed class ExternalNotification : IDatacenterObject<ExternalNotification>
{
	...
	public static ExternalNotification Deserialize(D2OClass d2OClass, BigEndianReader reader)
	{
