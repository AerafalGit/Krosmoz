...
public sealed class PartyNameUpdateMessage : AbstractPartyMessage
{
	public new const uint StaticProtocolId = 6502;

	public override uint ProtocolId =>
		StaticProtocolId;

	public static new PartyNameUpdateMessage Empty =>
