...
public sealed class QuestObjectiveBringItemToNpc : QuestObjective, IDatacenterObject<QuestObjectiveBringItemToNpc>
{
	public static new string ModuleName =>
		"QuestObjectives";

	public static new QuestObjectiveBringItemToNpc Deserialize(D2OClass d2OClass, BigEndianReader reader)
	{
		return new QuestObjectiveBringItemToNpc
		{
