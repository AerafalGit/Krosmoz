...
public sealed class AlignmentBalance : IDatacenterObject<AlignmentBalance>
{
	...
	public static AlignmentBalance Deserialize(D2OClass d2OClass, BigEndianReader reader)
	{
		return new AlignmentBalance
		{
