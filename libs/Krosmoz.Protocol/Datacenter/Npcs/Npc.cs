...
public sealed class Npc : IDatacenterObject
{
	...
	public void Deserialize(D2OClass d2OClass, BigEndianReader reader)
	{
		...
		DialogMessages = d2OClass.Fields[2].AsListOfList(reader, static (field, r) => field.AsInt(r));
		DialogReplies = d2OClass.Fields[3].AsListOfList(reader, static (field, r) => field.AsInt(r));
		Actions = d2OClass.Fields[4].AsList(reader, static (field, r) => field.AsUInt(r));
