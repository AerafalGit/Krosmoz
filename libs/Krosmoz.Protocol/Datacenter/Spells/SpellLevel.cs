...
public sealed class SpellLevel : IDatacenterObject
{
	...
	public void Deserialize(D2OClass d2OClass, BigEndianReader reader)
	{
		...
		StatesRequired = d2OClass.Fields[25].AsList(reader, static (field, r) => field.AsInt(r));
		StatesForbidden = d2OClass.Fields[26].AsList(reader, static (field, r) => field.AsInt(r));
