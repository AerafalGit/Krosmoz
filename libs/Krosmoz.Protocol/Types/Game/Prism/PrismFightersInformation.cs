...
public sealed class PrismFightersInformation : DofusType
{
	...
	public override void Serialize(BigEndianWriter writer)
	{
		...
		writer.WriteShort((short)allyCharactersInformationsCount);
		...
		writer.WriteShort((short)enemyCharactersInformationsCount);
	...
	public override void Deserialize(BigEndianReader reader)
	{
		...
		{
			var entry = Types.TypeFactory.CreateType<CharacterMinimalPlusLookInformations>(reader.ReadUShort());
