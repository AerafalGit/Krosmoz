...
public sealed class Job : IDatacenterObject<Job>
{
	...
	public static Job Deserialize(D2OClass d2OClass, BigEndianReader reader)
	{
		return new Job
		{
			...
			ToolIds = d2OClass.Fields[4].AsList<int>(reader, static (field, r) => field.AsInt(r)),
		};
	}
}
